...
html=html.replace('</body>','<script src="/amenity-photos.js"></script></body>');
...
for(const f of ['admin.html','admin.js','admin.css','amenity-photos.js'])fs.copyFileSync('ui/'+f,'dist/'+f);
