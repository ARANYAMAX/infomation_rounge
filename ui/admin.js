...
function fieldName(field){
 ...
 if(field.type==='image'&&['food','ARANYA_CURATED_PLACES'].includes(field.block)){const name=draft[field.block+':'+field.path[0]+'.name'];return plain(name?.values.ko||'장소')+' · 사진';}
